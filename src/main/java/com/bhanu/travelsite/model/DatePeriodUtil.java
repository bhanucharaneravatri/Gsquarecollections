...
public class DatePeriodUtil {
    ...
    public static boolean areOverlapping(DatePeriod period1, DatePeriod period2) {
        return (
                (period1.getStart().isBefore(period2.getStart()) || period1.getStart().isEqual(period2.getStart()))
                ...
                && (period1.getEnd().isAfter(period2.getEnd()) || period1.getEnd().isEqual(period2.getEnd()))
                );
    }
